<template>
  <view>
    ...
    <view class="uni-container">
      <unicloud-db ref="udb" collection="fuyin_privacy" field="title,content" :where="where" page-data="replace"
...
<script>
  import { enumConverter, filterToWhere } from '../../js_sdk/validator/fuyin_privacy.js';
