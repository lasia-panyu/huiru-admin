<template>
  <view>
    ...
    <view class="uni-container">
      <unicloud-db ref="udb" collection="uni-id-users,uni-id-roles" field="username,gender,status,mobile,email,department_id{name},nickname,role" :where="where" page-data="replace"
...
<script>
  ...
  const dbSearchFields = ['username','nickname','mobile','email','department_id'] // 模糊搜索字段，支持模糊搜索的字段列表
  // 分页配置
  const pageSize = 20
  const pageCurrent = 1
