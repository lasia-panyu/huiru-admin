<template>
  <view>
    ...
    <view class="uni-container">
      <unicloud-db ref="udb" collection="uni-id-users,uni-id-roles" field="username,nickname,gender,status,mobile,email,role{role_name}" :where="where" page-data="replace"
