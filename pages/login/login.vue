<template>
<view style="position: relative;padding-left: -50%;width: 100%;height: 100%;">
	<view style="width:100%;height: 100%;z-index: -999;position: absolute;">
		 <web-view :src="bg"  style="width: 100%;height: 100%;z-index: -999;"></web-view>		 
	</view>
	<view class="login-box" style="z-index: 999;">
		
       
		
		<view class="admin-logo" style="z-index: 1;" >
			<image :src="logo" mode="heightFix"></image>
			
		</view><strong></strong>
		<view class="uni-header no-padding">
			<view class="uni-title" style="text-align: center;width: 100%;">系统登录</view>
		</view>
		<view class="uni-container" style="z-index: 1;">
			<uni-forms ref="form" v-model="formData" :rules="rules" @submit="submit">
				<uni-forms-item left-icon="person-filled" iconColor="#fff" name="username"  labelWidth="35"  label-align="center">
				...
				<uni-forms-item left-icon="locked-filled" iconColor="#fff"  class="icon-container" name="password"
					...
					<input ref="passwordInput" @confirm="submitForm" class="uni-input-border" :password="showPassword"
						placeholder="密码" placeholder-style="color:#fff" v-model="formData.password" />
