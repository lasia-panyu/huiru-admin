  ...
  export default {
    ...
    methods: {
      ...
      getDetail(id) {
        ...
        db.collection(dbCollectionName).doc(id).field("name,mobile,idcard_type,idcard,address,from_abroad,province_code,city_code,area_code,from_address,transport,transport_no,status,comment,Health_code,na_test_time,na_test_result,temperature,cough").get().then((res) => {
